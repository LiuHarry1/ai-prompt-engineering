...
def execute_tool(tool_name, inputs):
    ...
    if tool_name == "shut_down_component":
        return "Announcement is down now "
    if tool_name == "start_up_component":
        return "Announcement component is up and running fine."
...
def get_bot_response(user_input):
    ...
    for i in range(3):
        ...
        action, action_input = get_action_and_action_input(new_bot_response)
